...
export default async function Home({ searchParams }) {
  ...
  if (search) {
    ...
    titleLabel = `${type === "tv" ? "TV Shows" : "Movies"} &raquo; ${genreName}`;
  } else {
    // JIKA DEFAULT (HOME): Tampilkan Trending Campuran All (Movie + TV) Hari Ini bawaan asli TMDB
  ...
  return (
    <div className="bg-[#0f0f0f] text-gray-100 min-h-screen py-8">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <h2 className="text-base font-black uppercase tracking-wider text-white mb-6 border-l-4 border-red-600 pl-3 capitalize">
          {titleLabel}
        </h2>
        ...
        {/* GRID UTAMA POSTER RATAR KANAN KIRI */}
